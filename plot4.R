...
par(mfrow = c(2, 2))
# Plot topleft
plot(dataset$DateTime, dataset$Global_active_power, type = "l", col = "black",
     xlab = "", ylab = "Global Active Power")

# Plot topright
plot(dataset$DateTime, dataset$Voltage, type = "l", col = "black",
...
# Plot bottomright
plot(dataset$DateTime, dataset$Global_reactive_power, type = "l", col = "black",
     xlab = "datetime", ylab = "Gloval_reactive_power")
